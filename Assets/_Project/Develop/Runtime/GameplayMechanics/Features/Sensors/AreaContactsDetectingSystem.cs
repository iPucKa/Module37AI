...
{
	public class AreaContactsDetectingSystem : IInitializableSystem, IUpdatableSystem
	{
		private ReactiveVariable<float> _areaContactRadius;
		...
		public void OnInit(Entity entity)
		{
			...
			_areaContactRadius = entity.AreaContactRadius;
		}
